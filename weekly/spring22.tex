...
\begin{document}
	...
	\begin{frame}{Observations}
		...
		\begin{columns}[t]
			...
			\end{itemize}
		\end{columns}
		~\\~\\About boundary conditions: reference density has to be constantly corrected, or velocity reset is required
	\end{frame}
	...
	\begin{frame}{Actions to take}
		\begin{itemize}
			...
			\item Start writing current findings (aiming to the paper)
			\item Others...
		\end{itemize}
	\end{frame}
