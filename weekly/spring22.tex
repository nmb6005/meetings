...
\begin{document}
	...
	\begin{frame}{Boundary conditions}
		Last meeting I raised some questions regarding the combination of boundary conditions. To clarify those points, the following was done:
	...
	\begin{frame}{Partial conclusions}
		\begin{itemize}
			...
			\item Pressure/Pressure oes not depict a transition of the boundary layer. Positive/negative impact on multiphase flow?
			
			\item Velocity/boundary is not conserving mass with current implementations. The effect is considerably reduced interpolating the velocity and applying the moving wall BC.
	...
	\begin{frame}{Two-components results}
		Regarding the two-components implementation (the main objective now to address the dynamic simulations) this was performed:
		
		\begin{itemize}
			\item The mixing rule for viscosity was implemented (falling droplet keeps accelerating)
			\item Programmed initialization of arbitrary composition or density field (was not possible to converge using concentration fields)
