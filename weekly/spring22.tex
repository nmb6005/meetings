...
\begin{document}
	...
	\begin{frame}{Actions}
		\begin{itemize}
			...
			\item Read Cheng's reports and find out if it is better to validate other cases
			\item Rising bubble regime that can be handled by the current $a,b$ from EOS.
			\item Oscillation case is done, but important to recognize why it is giving the increasing radius.
