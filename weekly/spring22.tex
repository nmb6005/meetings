...
\begin{document}
	...
	\begin{frame}[t]{Proposal review}
		...
		\begin{itemize}
			\item Rowlinson book to address the theory of continuum density profile
			\item LBM articles using Shan-Chen and surface force to account for confinement
			\item Found some references on Cahn-Hilliard and DFT (Firoozabadi). Some of them very complex.
			
		\end{itemize}
	\end{frame}
	
	\begin{frame}{Information sharing}
		Teams will be to share items. Bibliography in Drive. Shared Teams with Dr. Mehmani for weekly reports.
	\end{frame}
	%---------------------------------------------------------
	%---------------------------------------------------------
	\subsection{}
