...
\begin{document}
	...
	\begin{frame}{LBM Meeting}
		...
		\begin{itemize}
			\item The splitting coef. did not provide stable simulations for a rising bubble. Possible reasons
				\begin{itemize}
					\item Closed domain was used. 
					\item Incorrect setup for initial conditions
				\end{itemize}
			\item Main from last meeting: reproduce bubbly flow with simpler model and compare
		\end{itemize}
	...
	\begin{frame}{Simulation setup}
		...
		\begin{columns}[t]
			...
			\textbf{Initial conditions}: Bubble in equilibrium, $r_0, w_0$ = 24, 10 lu.
	...
	\begin{frame}{Partial conclusions}
		\begin{itemize}
			...
			\begin{itemize}
				\item Droplet splash against wall 
